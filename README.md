<div id="header" align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=auto&height=300&section=header&text=IRO's%20Tech%20Universe&fontSize=70&animation=poyopoyo&fontColor=ffffff&fontAlignY=38" alt="Header"/>
</div>

<div style="text-align: center; margin-top: 20px; margin-bottom: 20px;">
  <h2 style="font-weight: 900; font-size: 2.2em; background: linear-gradient(90deg, #FAD961 0%, #F76B1C 100%); -webkit-background-clip: text; color: transparent;">
...
<img src="https://capsule-render.vercel.app/api?type=line&color=auto&height=10&section=title&width=100%&animation=twinkling" alt="Divider"/>
...
<table width="100%" cellspacing="20" cellpadding="0" style="border: none;">
  <tr valign="top">
    <td width="50%">
      <div style="background-color: #ffffff; border-image: linear-gradient(to bottom right, #FAD961, #F76B1C) 1; border-width: 3px; border-style: solid; border-radius: 15px; padding: 25px; height: 100%; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);">
        <h3 align="center" style="font-weight: bold; color: #333;">
    ...
    <td width="50%">
      <div style="background-color: #ffffff; border-image: linear-gradient(to bottom right, #F76B1C, #FAD961) 1; border-width: 3px; border-style: solid; border-radius: 15px; padding: 25px; height: 100%; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1);">
        <h3 align="center" style="font-weight: bold; color: #333;">
        ...
        <ul style="list-style-type: '🛠️ '; padding-left: 20px; font-size: 15px; line-height: 1.9;">
...
<div style="background-color: #fff; border-image: linear-gradient(to right, #FAD961, #F76B1C) 1; border-width: 3px; border-style: solid; border-radius: 15px; padding: 25px; margin-top: 10px;">
...
<div style="background: linear-gradient(90deg, #fff3e0, #ffe0b2); border-left: 6px solid #F76B1C; padding: 20px; border-radius: 5px;">
